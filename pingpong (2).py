...
marcador_label = canvas.create_text(50, 30, text = f'Marcador: {marcador}', fill='white', font=('Arial', 18))
...
def actualizar_marcador():
  canvas.itemconfig(marcador_label, text = "Juego")
...
def actualizar_juego():
  global velocidad_x, velocidad_y, game_over
